...
The public API lives at the module root (`github.com/go-ruby-prawn/prawn`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `prawn`, while the surface follows
...
```go
import "github.com/go-ruby-prawn/prawn"
```
...
- **[pkg.go.dev/github.com/go-ruby-prawn/prawn](https://pkg.go.dev/github.com/go-ruby-prawn/prawn)**

The module's [README](https://github.com/go-ruby-prawn/prawn#readme) carries worked
