...
`go-ruby-prawn/prawn` reimplements Ruby's `prawn` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-prawn/prawn` directly, with no Ruby runtime;
